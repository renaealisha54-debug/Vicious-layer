...
class OverlayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (overlayView == null) {
            ...
            var flagsMask = WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL
            if (passthrough) {
                flagsMask = flagsMask or WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE
            }
    ...
    private fun executeJsUpdates(text: String, opacity: Int, color: String) {
        // Safe JavaScript structural update executions
        webView?.evaluateJavascript("if(typeof updateOverlayText === 'function') updateOverlayText('$text');", null)
