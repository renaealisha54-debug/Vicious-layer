...
class OverlayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("Persistent hardware system overlay loaded.")
            .setSmallIcon(android.R.drawable.ic_dialog_info)
            .setOngoing(true)
            .setCategory(NotificationCompat.CATEGORY_SERVICE)
            .build()
        
        // Android 14 (API 34) Safe Runtime Flag Execution Block
        ...
        if (overlayView == null) {
            ...
            // Native Window Hardware Matrix Drag Dispatcher
    ...
    companion object {
        const val CHANNEL_ID = "vicious_overlay_core"
