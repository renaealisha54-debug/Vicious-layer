...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnOverlayPerm.setOnClickListener {
            ...
            appendLog("Dispatched SYSTEM_ALERT_WINDOW settings intent map.", "INFO")
        }
        ...
        btnNotifPerm.setOnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                ...
                appendLog("POST_NOTIFICATIONS implicit system rule inherited automatically.", "INFO")
            }
        }
        ...
        btnStart.setOnClickListener {
            ...
            // Packaging hot settings payload explicitly
            ...
            // Update panel interface states to running configuration
            statusDot.setBackgroundColor(Color.parseColor("#30E088"))
            lblStatus.text = "OverlayService · RUNNING"
            lblDetail.text = "Sandbox initialized inside active WindowManager layer."
            btnStart.isEnabled = false
            btnStop.isEnabled = true
            appendLog("Foreground system process engine context instantiated.", "SUCCESS")
        }
        ...
        btnStop.setOnClickListener {
            ...
            appendLog("Subsystem engine instance explicitly torn down by hardware agent.", "WARN")
        }
    }

    private val requestNotifLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
    ...
    override fun onResume() {
        super.onResume()
        updatePermissionButtonStates(findViewById(R.id.btn_perm_overlay), findViewById(R.id.btn_perm_notif))
    }
}
